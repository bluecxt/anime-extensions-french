...
CORE_FILES_REGEX = re.compile(
    r"^(buildSrc/|core/|gradle/|build\.gradle\.kts|common\.gradle|gradle\.properties|settings\.gradle\.kts|.github/scripts|.github/workflows/)"
)
...
def get_module_list(ref: str) -> tuple[list[str], list[str]]:
    ...
    if os.getenv("IS_PR_CHECK") != "true" or core_files_changed:
