...
- [x] **Optimisation ProGuard/R8** : Affiner les règles `proguard-rules.pro` pour permettre la suppression (tree-shaking) des extracteurs centralisés dans le core qui ne sont pas utilisés par une extension spécifique.
